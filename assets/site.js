...
(function(){
  ...
  const DOWNLOAD_MACOS_ARM64 = 'https://privacypal-production-desktop-596719033801.s3.us-east-1.amazonaws.com/proxy/macos/PrivacyPal-1.9.12-arm64.dmg';
  ...
  <div class="pp-modal" id="ppDownloadModal" aria-hidden="true">
    <div class="pp-modal-card dl" role="dialog" aria-modal="true" aria-label="Download PrivacyPal">
      <div class="pp-modal-head">
        <h3>Download PrivacyPal · v1.9.12</h3>
        <button class="pp-modal-close" type="button" data-modal-close aria-label="Close">&times;</button>
      </div>
      <div class="pp-modal-body">
        <div class="pp-dl-grid">
          <div class="pp-dl-card win">
            ...
            <a class="pp-dl-btn win" href="https://privacypal-production-desktop-596719033801.s3.us-east-1.amazonaws.com/proxy/windows/PrivacyPal-Setup-1.9.12.exe" rel="noopener noreferrer">
